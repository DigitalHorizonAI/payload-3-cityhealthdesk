...
import { MOBILE_LINKS, NAV_LEFT, NAV_RIGHT, type NavLink } from '@/site'

/**
 * A sticky bar with links flanking a centered wordmark, carrying the sister
 * blog CMS's editorial chrome. No announcement bar: that slot advertises a
 * store offer, and this site has no store yet. The wordmark links to this
 * app's own home — there is no separate main site to point at.
 */
