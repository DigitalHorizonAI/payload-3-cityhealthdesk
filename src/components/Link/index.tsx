...
export const CMSLink: React.FC<CMSLinkType> = (props) => {
  ...
  // http/https/mailto/tel and relative hrefs. This is the ONLY link guard on
  // this site's article rendering — RichText/serialize.tsx is hand-rolled and
  // /api/articles serves the raw Lexical tree, so nothing upstream sanitizes
  // the href.
